...
mixin _$ApiResult<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(T? data, String? message, bool? status)
        successWithPages,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(T? data, String? message, bool? status)? successWithPages,
...
abstract class Success<T> implements ApiResult<T> {
  const factory Success(
      {final T? data,
      final String? message,
      final bool? status}) = _$SuccessImpl<T>;
...
class _$SuccessWithPagesImpl<T> implements SuccessWithPages<T> {
  const _$SuccessWithPagesImpl({this.data, this.message, this.status});
  ...
  @override
  String toString() {
    return 'ApiResult<$T>.successWithPages(data: $data, message: $message, status: $status)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return successWithPages(data, message, status);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return successWithPages?.call(data, message, status);
  }
...
abstract class SuccessWithPages<T> implements ApiResult<T> {
  const factory SuccessWithPages(
      {final T? data,
      final String? message,
      final bool? status}) = _$SuccessWithPagesImpl<T>;
